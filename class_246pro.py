...
def ethereum_block():
    ...
    gas_price_in_dollar = gas_price_in_ether*3380.40
    gas_price_in_rs = gas_price_in_ether*281806.58
    gas_price_in_pounds = gas_price_in_ether*2673.65
    # Start code for Task 3 below
    value_in_ether["text"] = "Value of gas in Ether:" + str(gas_price_in_ether)
    value_in_ether["text"] = "Value of gas in Dollar:" + str(gas_price_in_dollar)
    value_in_ether["text"] = "value of gas in Rs:" + str(gas_price_in_rs)
    value_in_ether["text"] = "value of gas in Pounds:" + str(gas_price_in_pounds)
    search_btn.destroy()
